...
const SLIDES = [
  { id: 'B1q9zP2K8wV', title: 'Across the Sahara', category: 'EPISODE 01', hook: 'I crossed the Sahara alone with no gear or crew. This is how it went.', img: '/vlog1.png' },
  { id: 'bV1q9zP2K8w', title: 'The Modern Job Escape', category: 'TECH ORIGINALS', hook: 'I quit my job to make videos full-time. Here is my setup and what I plan to do.', img: '/vlog2.png' },
  { id: 'v37-Sx5jN', title: 'Cooking on Lava: Iceland', category: 'FOOD ARCHIVE', hook: 'I traveled to find special recipes in nature. Here are the secrets I discovered.', img: '/vlog3.png' },
  { id: 'v20-Sx5jN', title: 'Solo Survival: Nordic', category: 'SURVIVAL SERIES', hook: 'I spent 24 hours in a very cold forest. It was a hard test for me.', img: '/vlog4.png' }
];
